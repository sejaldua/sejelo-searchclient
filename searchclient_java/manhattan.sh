...
# LEVEL: SAsoko1_64
java -jar ../server.jar -l ../levels/SAsoko1_64.lvl -c "java -Xmx8g searchclient.SearchClient -astar" -g -s 150 -t 180 > ../manhattan/md_SAsoko1_64_astar.txt 2>&1
...
# LEVEL: SAsoko2_64
java -jar ../server.jar -l ../levels/SAsoko2_64.lvl -c "java -Xmx8g searchclient.SearchClient -astar" -g -s 150 -t 180 > ../manhattan/md_SAsoko2_64_astar.txt 2>&1
...
# LEVEL: SAsoko3_64
java -jar ../server.jar -l ../levels/SAsoko3_64.lvl -c "java -Xmx8g searchclient.SearchClient -astar" -g -s 150 -t 180 > ../manhattan/md_SAsoko3_64_astar.txt 2>&1
